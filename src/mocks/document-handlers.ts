...
let documents: Document[] = [
  { id: "d1", title: "Getting Started Guide", content: "<h2>Welcome to Neuron Workspace</h2><p>This guide will help you get started with all the features available in your workspace.</p><h3>Quick Start</h3><ul><li>Create your first document</li><li>Organize with folders</li><li>Use templates for common workflows</li></ul>", folderId: null, favorite: true, archived: false, trashed: false, createdAt: new Date(Date.now() - 7 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 2 * 86400000).toISOString() },
  { id: "d2", title: "Q3 Product Roadmap", content: "<h2>Q3 Roadmap</h2><p>Key deliverables for Q3 2025:</p><ol><li>Launch dashboard v2</li><li>Implement real-time collaboration</li><li>Mobile app beta</li></ol><h3>Timeline</h3><p>July: Dashboard v2, August: Collaboration, September: Mobile beta</p>", folderId: "f1", favorite: true, archived: false, trashed: false, createdAt: new Date(Date.now() - 5 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 86400000).toISOString() },
  { id: "d3", title: "API Architecture Notes", content: "<h2>Architecture Decisions</h2><p>We decided to use RTK Query for the data layer with MSW for mocking during development.</p><h3>Key Decisions</h3><ul><li>REST API design</li><li>Tag-based cache invalidation</li><li>FakeBaseQuery for initial setup, fetchBaseQuery for production</li></ul>", folderId: "f3", favorite: false, archived: false, trashed: false, createdAt: new Date(Date.now() - 4 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 3 * 86400000).toISOString() },
  { id: "d4", title: "Design Tokens Specification", content: "<h2>Design Tokens</h2><p>Our design system uses CSS custom properties with oklch color space.</p><h3>Color Palette</h3><ul><li>Primary: oklch(0.205 0 0)</li><li>Secondary: oklch(0.97 0 0)</li><li>Chart colors: 5 variants for data visualization</li></ul>", folderId: "f2", favorite: false, archived: false, trashed: false, createdAt: new Date(Date.now() - 3 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 86400000).toISOString() },
  { id: "d5", title: "Meeting Notes: Sprint Review", content: "<h2>Sprint Review - Week 28</h2><p>Attendees: Demo User, Sarah Chen, Marcus Rivera</p><h3>Completed</h3><ul><li>Dashboard redesign</li><li>Auth module</li><li>MSW integration</li></ul><h3>Next Sprint</h3><p>Focus on document management and file uploads.</p>", folderId: "f1", favorite: false, archived: false, trashed: false, createdAt: new Date(Date.now() - 2 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 86400000).toISOString() },
  { id: "d6", title: "Weekly Journal - Week 27", content: "<h2>Week 27</h2><p>Great progress this week. Finished the dashboard workspace with all 11 widget components.</p><h3>Highlights</h3><ul><li>Productivity charts working with Recharts</li><li>Tasks widget with priority indicators</li><li>Team widget with online status</li></ul>", folderId: "f5", favorite: false, archived: false, trashed: false, createdAt: new Date(Date.now() - 86400000).toISOString(), updatedAt: new Date(Date.now() - 86400000).toISOString() },
  { id: "d7", title: "Component Library Audit", content: "<h2>Component Audit</h2><p>Current shadcn/ui components in use:</p><ul><li>14 base components</li><li>4 new additions (Tabs, Table, Badge, Select)</li><li>All using Radix UI primitives</li></ul>", folderId: "f2", favorite: false, archived: false, trashed: false, createdAt: new Date(Date.now() - 6 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 4 * 86400000).toISOString() },
  { id: "d8", title: "Old Project Notes", content: "<p>These are notes from an old project that has been completed.</p>", folderId: null, favorite: false, archived: true, trashed: false, createdAt: new Date(Date.now() - 30 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 20 * 86400000).toISOString() },
  { id: "d9", title: "Deleted Draft", content: "<p>This document was moved to trash.</p>", folderId: null, favorite: false, archived: false, trashed: true, createdAt: new Date(Date.now() - 15 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 10 * 86400000).toISOString() },
  { id: "d10", title: "Performance Report", content: "<h2>Performance Metrics</h2><p>Build size analysis:</p><ul><li>Index bundle: 517 KB (163 KB gzipped)</li><li>Dashboard: 377 KB</li><li>Notes: 387 KB</li></ul>", folderId: "f1", favorite: false, archived: false, trashed: false, createdAt: new Date(Date.now() - 86400000).toISOString(), updatedAt: new Date().toISOString() },
  { id: "d11", title: "Brainstorm: Feature Ideas", content: "<h2>Feature Ideas</h2><ul><li>Real-time collaboration</li><li>AI-powered document summaries</li><li>Version history</li><li>Comments and annotations</li><li>Export to PDF/Markdown</li></ul>", folderId: null, favorite: true, archived: false, trashed: false, createdAt: new Date(Date.now() - 9 * 86400000).toISOString(), updatedAt: new Date(Date.now() - 5 * 86400000).toISOString() },
  { id: "d12", title: "Weekly Journal - Week 28", content: "<h2>Week 28</h2><p>Started working on document management system. Planning the data model and API endpoints.</p><h3>Goals</h3><ul><li>Complete folder tree component</li><li>Implement document CRUD with folder organization</li><li>Add file upload mock</li></ul>", folderId: "f5", favorite: false, archived: false, trashed: false, createdAt: new Date(Date.now() - 86400000).toISOString(), updatedAt: new Date(Date.now() - 86400000).toISOString() },
]
